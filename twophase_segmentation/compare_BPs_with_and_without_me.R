...
knitr::kable(bps_compare_df, format = "pipe") %>% 
  save_kable("results/use_me_test/compare_BP_c57_f.txt")
### As Excel-compatible file
bps_compare_df %>% write_tsv("results/use_me_test/compare_BP_c57_f.tsv")
...
### As human-readable text
knitr::kable(bps_compare_df, format = "pipe") %>% 
  save_kable("results/use_me_test/compare_BP_c57_m.txt")
### As Excel-compatible file
bps_compare_df %>% write_tsv("results/use_me_test/compare_BP_c57_m.tsv")
...
### As human-readable text
knitr::kable(bps_compare_df, format = "pipe") %>% 
  save_kable("results/use_me_test/compare_BP_akrj_f.txt")
### As Excel-compatible file
bps_compare_df %>% write_tsv("results/use_me_test/compare_BP_akrj_f.tsv")
